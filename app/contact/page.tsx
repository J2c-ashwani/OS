            ...
            <main className="container mx-auto max-w-2xl px-6 py-16 flex-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-12 max-w-5xl mx-auto">
                    ...
                    <div className="lg:col-span-2 space-y-8">
                        <div>
                            <h2 className="text-3xl font-black text-[#0f172a] dark:text-white mb-4">Let's talk</h2>
                            <p className="text-slate-500 dark:text-slate-400 font-medium text-lg leading-relaxed">
                                Whether you're looking to monitor your response times, have questions about our enterprise plans, or just want to say hello, we'd love to hear from you.
                            </p>
                        </div>
