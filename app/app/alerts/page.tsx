...
import { MOCK_ALERTS } from '@/lib/data/store';
                    ...
                    <>
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
                            <div className="bg-[#111] border border-gray-800 rounded-lg p-6">
                                ...
                                <div className="text-3xl font-bold text-white">{MOCK_ALERTS.length}</div>
                            </div>
                            <div className="bg-[#111] border border-gray-800 rounded-lg p-6">
                                <div className="flex items-center justify-between mb-2">
                                    ...
                                    >
                                        <div className="flex flex-col sm:flex-row items-start justify-between gap-4">
                                            ...
                                            <div className="flex gap-2 w-full sm:w-auto">
                                                <button className="flex-1 sm:flex-initial px-4 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 text-emerald-500 rounded-lg text-sm font-medium transition-colors">
                                                    Resolve
                                                </button>
                                                <button className="px-3 py-2 bg-gray-800 hover:bg-gray-700 text-gray-400 rounded-lg transition-colors">
                                                    <X size={16} />
                                                </button>
                                            </div>
                                        </div>
