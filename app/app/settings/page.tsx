...
import { Home, Target, Activity, Bell, Settings, Save, RefreshCw } from 'lucide-react';
        ...
        <div className="min-h-screen bg-[#0A0A0A] text-gray-200">
            ...
            <aside className="fixed left-0 top-0 h-screen w-64 bg-[#111] border-r border-gray-900 p-6">
                ...
                <nav className="space-y-2">
                    ...
                    <Link href="/app/settings" className="flex items-center gap-3 px-4 py-2 rounded bg-emerald-500/10 text-emerald-500">
                        <Settings size={18} />
                        <span>Settings</span>
                    </Link>
                </nav>
